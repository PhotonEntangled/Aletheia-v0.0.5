            ...
            for tool_call in grounding_message.tool_calls:
                ...
                try:
                    ...
                    if function_name == "click":
                        ...
                        action_to_run = N8nAction(**arguments)
        ...
        tools = [
            {
                ...
                "function": {
                    ...
                    "description": "Trigger an N8N workflow by sending a POST request to a webhook URL.",
                    "parameters": {
                        "type": "object",
                        "properties": {
                            "webhook_url": {"type": "string", "description": "The N8N webhook URL to trigger."},
                            "payload": {"type": "object", "description": "A JSON object to send as the request body."}
                        },
