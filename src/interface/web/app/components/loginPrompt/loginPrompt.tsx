...
function EmailSignInContext({
    ...
    function checkOTPAndRedirect() {
        const verifyUrl = `/auth/magic?code=${encodeURIComponent(otp)}&email=${encodeURIComponent(email)}&remember_me=${rememberMe}`;
    ...
    return (
        <div className="flex flex-col gap-4 p-4">
            ...
            <div>
                <div className="text-center font-bold text-xl">Get started with Aletheia</div>
            </div>
